...
<body>
    <nav class="navbar navbar-expand-md bg-black navbar-dark">
        <div class="container">
            ...
            <a class="navbar-brand" href="fazer-pedido.php">
                <h1 class="m-0"><img src="../../assets/img/logocafe.png" class="d-block" alt="Logo da Cafeteria Gourmet"></h1>
            </a>
    ...
    <div class="container">
        <h6 class="pt-4">Faça seu pedido</h6>
                ...
                <img src = "../../assets/img/produtos/<?php echo $encontrados["img"];?>" width="150px" class="pt-3 mx-auto"/>
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group justify-content-center">
                            ...
                            <button class="button-64" role="button" onclick="addCarrinho<?php echo $contador2;?>(<?php echo $encontrados['id_produto']?>)" class="btn btn-success rounded-end-3" name="bt_comprar"><i class="bi bi-cart-fill fs-6" style="margin-right:7px;"></i><button class="button-64" role="button"><span class="text">Comprar</span></button></button>
...
?>
    ...
    <footer class="container-fluid text-center bg-dark text-light">
        ...
        <p class="card-text pb-3" style="font-size: 10px;">2024 <i class="bi bi-c-circle"></i> Desenvolvido por Equipe de Trabalho - Alunos PIT 2 | Projeto para
obtenção da nota do PIT 2</p>
        </div>
    </footer>
